...
const smallStraight = new LargeStraight({ score: 30, description: '30 points for a small straight' });
const largeStraight = new LargeStraight({ score: 40, description: '40 points for a small straight' });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, description: '50 poings for a yahtzee' });
